        ...
        Self {
            ...
            artifacts: vec![
                HandoffInstructionArtifact::conservative(
                    ...
                    "Unpack the latest repository ZIP, read governance files before changes, run the structure validator, preserve all unresolved gaps, and do not enable live trading, signing, broadcasts, withdrawals, bridges, public exposure, or production claims.",
            ...
            unresolved_gap_ids,
            live_funds_blockers,
            next_required_action: "Run external Rust validation and production-hardening evidence generation in a capable environment before any production or live-funds claim".to_owned(),
