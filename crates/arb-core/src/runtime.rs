...
use crate::{
    ...
    ExecutionAdapterError, ExecutionAdapterRequest, ExecutionAdapterRunRecord, ExecutionPlanDraft,
    ExecutionScope, PolicyEngine, StateCheckpoint, StateStore, StateStoreError,
...
mod tests {
    use super::{
        run_local_runtime_lifecycle, RuntimeLifecycleRequest, RuntimeLifecycleStatus,
        EXECUTION_ADAPTER_LAST_RUN_CHECKPOINT_KEY, EXECUTION_PLANNER_LAST_DRAFT_CHECKPOINT_KEY,
    };
    use crate::{
        AgentConfig, AppendOnlyAuditJournal, DeterministicExecutionPlanner, ExecutionAdapterConfig,
        ExecutionPlanner, ExecutionPlannerConfig, ExecutionPlannerRequest, FeeAdjustedEdge,
        FeeEstimate, InMemoryStateStore, LiquidityRole, MarketPair, OpportunityCandidate,
