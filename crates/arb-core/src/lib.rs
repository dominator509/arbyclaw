...
pub use packaging::{
    ...
    validate_rollback_execution_transcript, DeploymentEnvironmentKind, DeploymentNetworkExposure,
    DeploymentPackagePlan, DeploymentPackageRecord, DeploymentPackageRequest,
    DeploymentPackageStatus, DeterministicPackagingDeploymentPlanner,
