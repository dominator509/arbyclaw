...
- Focused validation for this section is `python scripts/validate_agentic_handoff_candidate_gate.py --json` plus a pushed GitHub Actions run on `main`.
