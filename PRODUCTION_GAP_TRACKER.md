...
- Branch: `main`
- Latest validated commit: `6df064737415c127f01417a78fe2295783b2e150`
- Workflow run: `https://github.com/dominator509/arbyclaw/actions/runs/26438765491`
- Result: passed.
...
- Artifact references from that run: `hardening-evidence-index` `7211449115`, `codeql-sarif-evidence` `7211357051`, `trivy-image-scan-evidence` `7211323322`, `gitleaks-secret-scan-evidence` `7211293903`, and Docker Buildx build record `7211323910`.
...
- Latest referenced GitHub Actions validation passed on `main` in run `https://github.com/dominator509/arbyclaw/actions/runs/26438765491` for commit `6df064737415c127f01417a78fe2295783b2e150`.
