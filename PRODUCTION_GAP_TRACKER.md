...
- Branch: `main`
- Latest validated commit: `8d553ff7cbc395fdb127e021f1cd059411dc1cb5`
- Workflow run: `https://github.com/dominator509/arbyclaw/actions/runs/26438050717`
- Result: passed.
...
- Artifact references from that run: `hardening-evidence-index` `7211154578`, `codeql-sarif-evidence` `7211059992`, `trivy-image-scan-evidence` `7211029975`, `gitleaks-secret-scan-evidence` `7211001678`, and Docker Buildx build record `7211030411`.
...
- Latest referenced GitHub Actions validation passed on `main` in run `https://github.com/dominator509/arbyclaw/actions/runs/26438050717` for commit `8d553ff7cbc395fdb127e021f1cd059411dc1cb5`.
