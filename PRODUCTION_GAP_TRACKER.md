...
- Why incomplete: Local lifecycle, runtime-smoke, deployment-report, paper runtime, and config reload validation records exist, but deployment-host startup, service management, soak, restart, deployment-host config reload, permissions under real orchestration, and observability validation remain external.
