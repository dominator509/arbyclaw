...
- Branch: `main`
- Latest validated commit: `0166f952d79e34bc2a93498a4d2dc31fc41f2676`
- Workflow run: `https://github.com/dominator509/arbyclaw/actions/runs/26442520939`
- Result: passed.
...
- Artifact references from that run: `hardening-evidence-index` `7212995610`, `codeql-sarif-evidence` `7212895537`, `trivy-image-scan-evidence` `7212882230`, `gitleaks-secret-scan-evidence` `7212832600`, and Docker Buildx build record `7212882843`.
...
- Latest referenced GitHub Actions validation passed on `main` in run `https://github.com/dominator509/arbyclaw/actions/runs/26442520939` for commit `0166f952d79e34bc2a93498a4d2dc31fc41f2676`.
