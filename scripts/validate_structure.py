...
REQUIRED_FILES = [
    ...
    "docs/refactoring/BEHAVIOR_COMPATIBILITY_CONTRACT.md",
    "validation/architecture_ratchets.json",
    "validation/behavior_contract.json",
    "validation/external_evidence.json",
    "validation/validation_graph.json",
    ...
    "scripts/validate_architecture_ratchets.py",
    "scripts/validate_validation_graph.py",
    "scripts/validate_behavior_contract.py",
    "scripts/validate_assurance_integrity.py",
