...
def build_report(
    ...
    *,
    ...
    trivy_table_container = f"arbyclaw-production-trivy-table-{os.getpid()}"
    trivy_gate_container = f"arbyclaw-production-trivy-gate-{os.getpid()}"
    try:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="bounded timeout for the production-intent image build",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="bounded timeout for each inert container help smoke",
    )
