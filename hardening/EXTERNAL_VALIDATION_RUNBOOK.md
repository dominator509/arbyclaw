...
1. Record reviewer name or approved handle, reviewer role, review date, evidence scope, outcome, and unresolved gaps.
...
6. Require a fresh sign-off whenever evidence is refreshed, the reviewed commit changes, or release-relevant gaps change.
