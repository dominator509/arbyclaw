...
| 27 | Opportunity Depth, Inventory, and Transfer-Risk Modeling | Implemented as local deterministic opportunity realism; external calibration and broader scenario validation deferred | +0% direct | Adds optional caller-supplied order-book depth walking, paper inventory caps, transfer-risk profile penalties, same-venue triangular path search, and candidate liquidity/transfer-risk records without live data calls, real transfers, signing, broadcasts, or execution. |
...
- Broader triangular route scenario replay and false-positive validation.
