...
- Phase 24 local paper venue matching, adverse-selection, reference-only calibration, ledger replay, historical-fixture backtest execution, and runtime validation records implemented.
