...
- Phase 9 deterministic opportunity-engine discovery/ranking models implemented; Phase 27 adds local depth, paper inventory, transfer-risk, triangular path, replay/false-positive modeling, local historical fixture replay, and replay-candidate planner handoff validation without live calls.
