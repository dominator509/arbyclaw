...
- Opportunity engine has current workspace Rust validation evidence and now models local caller-supplied order-book depth, paper inventory caps, and transfer-risk penalties, but full triangular path discovery, broader scenario validation, and external sandbox/live calibration remain missing
