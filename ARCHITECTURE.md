...
- `arb-core::opportunity` defines `OpportunityDiscoveryConfig`, `OpportunityDiscoveryRequest`, `OpportunityCandidate`, `OpportunityLeg`, `OpportunityScore`, `OpportunityRouteKind`, local replay corpus/report records, `OpportunityEngine`, and `DeterministicOpportunityEngine`.
